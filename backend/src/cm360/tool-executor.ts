...
import { executeToolMock, aiTagAttribution, aiReportMetadata, type ToolResult } from '@adtraffic/shared/mock-cm360';
...
// ToolResult, the mock executor (executeToolMock), and the EU AI Act attribution
// helpers (aiTagAttribution / aiReportMetadata) now live in
// @adtraffic/shared/mock-cm360 (imported above). ToolResult is re-exported here
// so existing importers (qa/qa-read.ts, routes/approvals.ts) keep resolving.
